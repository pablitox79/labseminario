package com.examcasdauihple.pablitox.practica222.ItemMenu;
...
import com.examcasdauihple.pablitox.practica222.R;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView==null){
            ...
            if (this.list.get(position).getImg()==null){
                ...
                loader.setOnloadCompleImg(img,position,this);
                loader.execute(this.list.get(position).getImg());
            }
            return convertView;
    }
